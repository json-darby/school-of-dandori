...
export default function Home() {
  ...
  useEffect(() => {
    getCourses()
      .then((data) => {
        setCourses(data);
        /** Initialises max price based on course data. */
  ...
  /** Computes derived data required for filters. */
  ...
  /** Applies active filtering and sorting rules to course data. */
  const filteredCourses = useMemo(() => {
    ...
    switch (filters.sortBy) {
      ...
      case 'name_asc':
        ...
        break;
      default:
        /** Uses recommended order (default course list ordering). */
        break;
    }
  ...
  return (
    ...
    >
      ...
      <main className="flex-grow container mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-[80vh] relative">
        {/* Renders decorative structural background lines. */}
        ...
        <AnimatePresence mode="wait">
          {viewState === 'landing' ? (
            ...
            >
              ...
              {/* Displays the course filter and sort controls. */}
              <FilterBar 
                locations={locations} 
                types={types} 
                filters={filters} 
              ...
              {/* Renders the course results and layout toggles. */}
              {loading ? (
                ...
                <>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    {/* Toggles the layout tile shape between acorn and leaf. */}
                    <button
                          ...
                          {tileShape === 'acorn' ? (
                            ...
                            <>
                              ...
                              >
                                ...
                                {/* Renders the stem of the acorn. */}
                                <rect x="145" y="40" width="10" height="25" rx="4" fill="#4a3a2a" />
                                
                                {/* Renders the textured, rounded cap of the acorn. */}
                                ...
                                {/* Renders the cap rim with a shadow effect. */}
                                ...
                                {/* Renders the bulbous body of the acorn. */}
                                <path
                                  d="M 50 110 
                                     Q 45 160, 50 210
                                     Q 55 260, 80 300
                                ...
                                {/* Applies a wood grain texture overlay. */}
                                <path
                                  d="M 50 110 
                                     Q 45 160, 50 210
                                     Q 55 260, 80 300
                                ...
                                {/* Adds a light highlight to the acorn body. */}
                            ...
                            <>
                              ...
                              >
                                ...
                                {/* Applies a vein texture overlay. */}
                                <path
                                  d="M 150 40 
                                     Q 210 80, 240 140
                                     Q 260 200, 240 260
                                ...
                                {/* Renders the prominent centre vein. */}
                                <path
                                ...
                                {/* Renders the secondary side veins. */}
                                ...
                                {/* Adds a light highlight to the leaf shape. */}
                  ...
                  {/* Handles loading of subsequent course results. */}
