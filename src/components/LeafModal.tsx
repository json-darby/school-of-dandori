    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Renders the cross-section SVG of the tree stump. */}
            <svg
            ...
            >
              <defs>
                {/* Defines the gradient for the wood texture. */}
                ...
                {/* Defines the pattern for the bark texture. */}
              ...
              {/* Renders the outer bark edge circle. */}
              <circle
                cx="500"
                cy="500"
                r="480"
              ...
              {/* Renders the main wood surface circle. */}
              <circle
                cx="500"
                cy="500"
                r="460"
              ...
              {/* Renders six concentric tree rings with varied thicknesses. */}
              ...
              {/* Renders additional detail rings between the main concentric rings. */}
              ...
              {/* Renders a detailed central heartwood knot. */}
              <circle
                cx="500"
                cy="500"
                r="45"
              ...
              {/* Renders structural cracks in the wood block. */}
              <path
              ...
              {/* Renders decorative wood grain texture lines. */}
              <path
              ...
              {/* Renders an animated ladybug navigating the outer ring. */}
              <g>
              ...
              {/* Renders an animated ant navigating the middle ring. */}
              <g>
              ...
              {/* Renders an animated beetle navigating the inner ring. */}
              <g>
              ...
              {/* Renders an animated flying bee in a figure-of-eight pattern around the centre. */}
              <g>
                {/* Renders the main body of the bee. */}
                ...
                {/* Renders the decorative black stripes. */}
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-[85%] h-[85%] overflow-y-auto pointer-events-auto custom-scrollbar">
                <div className="px-6 py-5">
                  ...
                  {/* Renders a grid showing instructor, location, and cost details. */}
                  ...
                  {/* Displays the learning objectives of the course. */}
                  <div className="mb-3 bg-white/95 backdrop-blur-sm rounded-xl p-5 shadow-lg">
                  ...
                  {/* Renders badges for developed skills. */}
                  ...
                  {/* Lists all provided course materials. */}
                  ...
                  {/* Course booking confirmation action button. */}
                  <button
                    onClick={onBook}
            ...
            {/* Renders a button to close the modal. */}
            <button
              onClick={onClose}
