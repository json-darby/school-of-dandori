...
/**
 * Renders the filter and sort bar component.
 * 
 * Provides interactive drop-downs and ranges to filter courses by location,
 * type, maximum cost, and sorting criteria.
 */
  ...
  return (
    <div className="bg-dandori-dark p-4 rounded-2xl shadow-lg text-white mb-8">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
        ...
        {/* Renders the location filter selection control. */}
        ...
        {/* Renders the course type filter selection control. */}
        <div className="space-y-1">
        ...
        {/* Renders the maximum price range slider control. */}
        <div className="space-y-1">
        ...
        {/* Renders the course sorting criteria selection control. */}
        <div className="space-y-1">
        ...
        {/* Renders the page results limit selection control. */}
        <div className="space-y-1">
