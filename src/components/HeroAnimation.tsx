...
/**
 * Renders the interactive hero animation component.
 * 
 * Showcases the transition from a serious professional "adult" outer shell
 * to a playful "inner child" core upon user interaction.
 */
export default function HeroAnimation() {
  return (
    <div className="relative w-64 h-64 mx-auto cursor-pointer group perspective-1000">
      {/* Renders the "adult" outer shell container. */}
      <motion.div 
      ...
      {/* Renders the "inner child" core container. */}
      <motion.div 
      ...
      {/* Generates decorative background burst particles on hover. */}
